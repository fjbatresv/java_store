 ...
 */
@Stateless
@Path("com.javastore.entities.productocategoria")
public class ProductoCategoriaFacadeREST extends AbstractFacade<ProductoCategoria> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, ProductoCategoria entity) {
        super.edit(entity);
    }
    ...
    public ProductoCategoria find(@PathParam("id") Integer id) {
